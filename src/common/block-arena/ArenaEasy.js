...
export default class ArenaEasy {
  ...
  draw() {
    new IronBlock(
      ...
      Math.round(window.gameCanvasObject.canvas.width / 48) + 1
    ).draw();
    ...
    new IronBlock(
      this.id,
      Math.round(window.gameCanvasObject.canvas.width / (48 * 2)) * 48 - 48 + 48 * 5,
    ...
    new IronBlock(
      ...
      Math.round(window.gameCanvasObject.canvas.width / (48 * 2))
    ).draw();

    new IronBlock(
      this.id,
      Math.round(window.gameCanvasObject.canvas.width / (48 * 2)) * 48 - (48 *2),
